...
import continuum.cucumber.testRunner.Runner;
	 ...
	 *  Implements testng listner to take screenshot on failure
	 */
				...
				if(!result.isSuccess())
		    		{
							...
							String screenShotName = Runner.getFeatureName()+ dateFormat.format(new Date())+".jpg";
...
//				try {
//					Thread.sleep(6000);
//					if(SeleniumServerUtility.getSeleniumServerStatus())
